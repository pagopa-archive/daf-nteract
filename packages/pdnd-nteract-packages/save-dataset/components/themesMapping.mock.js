    ...
    subthemes: [
      {
        ...
        subthemes_ita: [["5606", "politiche agricole"]]
      },
      {
      ...
      },
      {
        ...
        subthemes_ita: [["5641", "pesca"], ["6011", "prodotto animale"]]
      }
    ]
  },
  {
    ...
    subthemes: [
      {
        ...
        subthemes_ita: [["6606", "politica energetica"]]
      },
      {
  ...
  },
  {
    ...
    subthemes: [
      ...
      },
      {
        ...
        subthemes_ita: [["4816", "trasporti terrestri"]]
      },
      {
        subtheme_daf_code: "aereo",
        subtheme_daf_ita: "Trasporti Aerei",
        subthemes_ita: [["4826", "trasporti aerei e spaziali"]]
      },
      {
        subtheme_daf_code: "marittimo",
        subtheme_daf_ita: "Trasporto Marittimo",
        subthemes_ita: [["4821", "trasporti marittimi e fluviali"]]
      }
    ]
  },
    ...
    subthemes: [
      {
        ...
        subthemes_ita: [["5206", "politica dell'ambiente"]]
      },
      {
...

  {
    ...
    subthemes: [
      ...
      },
      {
        ...
        subthemes_ita: [["2831", "cultura e religione"]]
      },
      {
        subtheme_daf_code: "eventi",
        subtheme_daf_ita: "Eventi",
        subthemes_ita: [["2826", "vita sociale - tempo libero"]]
      },
      {
...
const themesMapping = themes.map(
  ({ theme_code, theme_daf_ita, subthemes }) => ({
    code: theme_code,
    label: theme_daf_ita,
    subthemes: subthemes.map(({ subtheme_daf_code, subtheme_daf_ita }) => ({
      code: subtheme_daf_code,
      label: subtheme_daf_ita
    }))
  })
);

export default themesMapping;
